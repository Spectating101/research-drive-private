...
def main() -> int:
    ...
    specs: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "name": "Stablecoin trust ↔ engagement (weekly panel)",
            ...
            "local_path": "data/datasets/stablecoin_trust_engagement/latest/panel_weekly.csv",
            "description": (
                "Multi-source synthesis: Skynet security, community growth, GDELT mentions, "
                "DeFiLlama supply/peg, incidents, Wikipedia, GitHub — entity×week research panel."
            ),
            "join_keys": ["entity_id", "week"],
            "partition_id": PARTITION_ID,
            "recommended_use": "Stablecoin trust and engagement event studies; flagship derived lab holding.",
            ...
            "path": REPO / "data/datasets/stablecoin_trust_engagement/latest/panel_weekly.csv",
        },
    ]
