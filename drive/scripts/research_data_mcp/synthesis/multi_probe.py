...
def probe_many(
    ...
    *,
    ...
    ``intersections`` are exclusive membership regions: mask 0b101 means a key is
    present in sources 0 and 2 and absent from every other measured source. Those
    counts are sufficient for a true 3-set Venn and for an UpSet plot at 4+ sets.
    """
    ...
    for index, source in enumerate(rows):
        ...
        # whether a CSV has one more row, so equality is conservatively treated as
