/**
 * Page-specific empty Detail copy — one line, no guide dump.
 * No imports — safe for plain `node --test`.
 */
export const PAGE_DETAIL_EMPTY = Object.freeze({
