...
| 3a | [`DISCOVER_LOOP_ANCHOR.md`](DISCOVER_LOOP_ANCHOR.md) | Discover Search/Activity loop + 1920 gates (amend here, don’t redesign shell) |
...
| 6 | [`LAYOUT_SPEC.md`](LAYOUT_SPEC.md) | Pixel zones (1440×900 reference; Discover gates use 1920) |
