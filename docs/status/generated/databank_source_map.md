...
Generated: 2026-07-14T07:19:48+00:00

## Summary

- Registry datasets: **162**
- Mapped to a source system: **162**
- Unmapped: **0**
- Source systems defined: **25**
...
- **Mode:** derived_internal · **Status:** active · **Materialized:** yes · **Registry cards:** 20 (19 instant)
...
### In-house synthesis thread outputs (`derived_synthesis`)
- **Mode:** derived_internal · **Status:** active · **Materialized:** yes · **Registry cards:** 2 (2 instant)
- **Gaps:** Outputs are derived aggregates; raw vendor bytes remain on upstream source_id cards; Thread output directories may be GC'd after Drive promotion — registry local_path can be stale while canonical_remote remains authoritative
- **Note:** Bounded synthesis_execute materialisations. Map by synthesis_ prefix only — do not reassign these cards to upstream vendors. Upstream lineage is lineage.upstream_dataset_ids (and execution manifests), not this source id.
...
### SEC EDGAR (`sec_edgar`)
- **Mode:** materialized_instant · **Status:** active · **Materialized:** yes · **Registry cards:** 3 (1 instant)
...
- **Mode:** procurement_catalog · **Status:** active · **Materialized:** live/partial · **Registry cards:** 28 (20 instant)
- **Desk connector:** Web (arbitrary)
